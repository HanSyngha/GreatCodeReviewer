...
TEST(ParserTest, ParserDELbyname) {
	Parser parser;
	parser.parse("ADD, , , ,15123099,MPOSXU,CL3,010-3112-2609,19771211,ADV");
...
TEST(ParserTest, ParserSRHdefult) {
	...
	EXPECT_EQ(parser.parse("SCH,-p, , , certi, ADV"), "SCH, 15123099, MPOSXU, CL3, 010 - 3112 - 2609, 19770901, ADV");
	EXPECT_TRUE(true);
}
